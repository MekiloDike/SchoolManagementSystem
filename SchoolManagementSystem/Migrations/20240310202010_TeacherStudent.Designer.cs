...
namespace SchoolManagementSystem.Migrations
{
    ...
    [Migration("20240310202010_TeacherStudent")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagementSystem.Models.TeacherStudent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StudentStudentCourse", b =>
                {
                    ...
                    b.HasKey("StudentCourseId", "StudentsId");
            ...
            modelBuilder.Entity("StudentTeacherStudent", b =>
                {
                    b.Property<string>("StudentsId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("StudentsId", "TeacherStudentId");

                    b.HasIndex("TeacherStudentId");

                    b.ToTable("StudentTeacherStudent");
                });

            modelBuilder.Entity("TeacherTeacherStudent", b =>
                {
                    b.Property<string>("CourseId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("CourseId", "TeacherStudentId");

                    b.HasIndex("TeacherStudentId");

                    b.ToTable("TeacherTeacherStudent");
                });
            ...
            modelBuilder.Entity("StudentStudentCourse", b =>
                {
                    b.HasOne("SchoolManagementSystem.Models.StudentCourse", null)
                        .WithMany()
                        .HasForeignKey("StudentCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StudentTeacherStudent", b =>
                {
                    ...
                    b.HasOne("SchoolManagementSystem.Models.TeacherStudent", null)
                        .WithMany()
