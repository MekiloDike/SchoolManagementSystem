    ...
    public partial class connectToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NonAcademics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NonAcademics_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NonAcademics_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GuidianName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NonAcademics_SchoolId",
                table: "NonAcademics",
                column: "SchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_NonAcademics_UserId",
                table: "NonAcademics",
                column: "UserId");
